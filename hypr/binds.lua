...
hl.bind(super .. " + " .. super .. "_L", hl.dsp.exec_cmd(menu))
...
local function moveWindow(dir) -- function is in case i want to change window moving behavior to factor in worspaces
